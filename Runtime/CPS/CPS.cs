...
public class CPS 
{
    ...
    public static CPS_DroneSoccerMatchState CPS_DroneSoccerMatchState = new CPS_DroneSoccerMatchState();
    public static CPS_DroneSoccerMatchStaticInformation CPS_DroneSoccerMatchStaticInformation = new CPS_DroneSoccerMatchStaticInformation();
    public static CPS_DroneSoccerPositions CPS_DroneSoccerPositions = new CPS_DroneSoccerPositions();
    public static CPS_DroneSoccerPublicXmlRsaKey1024Claim CPS_DroneSoccerPublicXmlRsaKey1024Claim = new CPS_DroneSoccerPublicXmlRsaKey1024Claim();
    public static CPS_DroneSoccerTimeValue CPS_DroneSoccerTimeValue = new CPS_DroneSoccerTimeValue();
